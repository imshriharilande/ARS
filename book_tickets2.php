...
<html>
	...
	<body>
		...
		<?php
			...
			echo "<form action=\"add_ticket_details_form_handler.php\" method=\"post\" class=\"center_form\" id=\"new_user_from\">" ;
			while($count<=$no_of_pass)
			{
				    echo "<h3><strong>PASSENGER ".$count."<strong></h3><br>";
				    echo "<h5 class=\"fix_table_short\">Passenger's Name</h5>";
					echo"<input type=\"text\" name=\"pass_name[]\" required>";

					echo "<h5 class=\"fix_table_short\">Passenger's Age</h5>";
					echo"<input type=\"number\" name=\"pass_age[]\" required>";

					echo "<h5 class=\"fix_table_short\">Passenger's Gender</h5>";
				    echo "<select name=\"pass_gender[]\">";
  					echo "<option value=\"male\">Male</option>";
  					echo "<option value=\"female\">Female</option>";
  					echo "<option value=\"other\">Other</option>";
  					echo "</select>";
					echo "<h5 class=\"fix_table_short\">Passenger's Inflight Meal</h5>";
					echo "<select name=\"pass_meal[]\">";
  					echo "<option value=\"yes\">Yes</option>";
  					echo "<option value=\"no\">No</option>";
  					echo "</select>";
					echo "<h5 class=\"fix_table_short\">Passenger's Frequent Flier ID (if applicable)</h5>";
					echo"<input type=\"text\" name=\"pass_ff_id[]\"   />";
					echo "<br><hr>";
					$count=$count+1;
				}
				echo "<br><h3><strong>ENTER TRAVEL DETAILS</strong></h3><br>";
				echo "<h5 class=\"fix_table_short\">Do you want access to our Premium Lounge?</h5>";
				echo "Yes <input type='radio' name='lounge_access' value='yes' checked/> No <input type='radio' name='lounge_access' value='no'/>";
				echo "<h5 class=\"fix_table_short\">Do you want to opt for Priority Checkin?</h5>";
				echo "Yes <input type='radio' name='priority_checkin' value='yes' checked/> No <input type='radio' name='priority_checkin' value='no'/>";
				echo "<h5 class=\"fix_table_short\">Do you want to purchase Travel Insurance?</h5>";
				echo "Yes <input type='radio' name='insurance' value='yes' checked/> No <input type='radio' name='insurance' value='no'/>";
				echo "<br><br>";
				echo "<button type=\"submit\" value=\"Submit\" name=\"Submit\" name=\"Submit\">Sign Up</button>";
				echo "</form>";
				echo "<br><br>";
		?>
