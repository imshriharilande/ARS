...
$flight_no = $n['flight_no'];
$qnn = mysqli_query($con, "SELECT from_city, to_city FROM flight_details WHERE flight_no='" . $flight_no . "'");
if (mysqli_num_rows($qnn) > 0) {
  $row = mysqli_fetch_assoc($qnn);
  $from_city = $row['from_city'];
  $to_city = $row['to_city'];
  // Now $from_city and $to_city contain the values fetched from the flight_details table
} else {
...
<br><center><h2>Boarding Pass - Flight Reservation Slip</h2><br><h3>STATUS<h3></center><h4><center><?php echo $booking_status;?></center></h4>
<body>         
  <div class="container-fluid">
                            <div class="row">
                               <div class="col-sm-12">
      <center>  <table class="table table-bordered" style="font-family: Verdana">
                ...
                <center><font style="font-family:Arial Black; font-size:20px;">
                   ...
                   $row1 = mysqli_fetch_array($result1)  ; 
                        ...
                        $ftt = substr($from_city, 0, 3);
                        $ttt = substr($to_city, 0, 3);
                   ?>
                ...
                <div class="box">
                  ...
                  <div class="ticket">
                    <span class="airline"><?php echo $flight_no;?></span>
                    <span class="airline airlineslip"><?php echo $flight_no;?></span>
                    <span class="boarding">Boarding pass</span>
                    <div class="content">
                      <span class="jfk"><?php echo $ftt;?></span>
                      ...
                      <span class="sfo"><?php echo $ttt;?></span>
                      
                      <span class="jfk jfkslip"><?php echo $ftt;?></span>
                      ...
                      <span class="sfo sfoslip"><?php echo $ttt;?></span>
                      <div class="sub-content">
                        <span class="watermark">Shree</span>
                        <span class="name">PNR<br><span><?php echo $id;?></span></span>
                        <span class="flight">FLIGHT N&deg;<br><span><?php echo $flight_no;?></span></span>
                        <span class="gate">CLASS<br><span style="text-transform:uppercase;"><?php echo $class;?></span></span>
                        <span class="boardingtime">BOARDING TIME<br><span><?php echo $journey_date;?></span></span>
                            
                        <span class="flight flightslip">FLIGHT N&deg;<br><span><?php echo $flight_no;?></span></span>
                          <span class="seat seatslip">PNR<br><span><?php echo $id;?></span></span>
                        <span class="name nameslip">PASSENGER NAME<br><span style="text-transform:uppercase;"><?php echo ''. $row[2]. '   ' ?></span></span>
                      </div>
                    </div>
...
<CENTER><a class="print_hide" href="pnr.php">Check other PNR</a></center><br>
