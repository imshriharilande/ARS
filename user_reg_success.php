...
<html>
	...
	<nav style="background: linear-gradient(to bottom, #3370c6, #ffffff);" class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm stickey-top">
			<div class="container-fluid">
				...
				<div class="d-flex">
				<button type="button" class="btn btn-outline-dark shadow-none" data-bs-toggle="modal" onclick="login()">Login</button>
		...
		<h3 style="text-align:center">New user successfully registered! Login into your account to book tickets.</h3><br>
