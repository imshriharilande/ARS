	...
	<div  id="divtop">
		<center>
			...
			?>
					...
					<input type="text" id="u_id" name="pnr" required style="width:300px; margin-center: 66px;" placeholder="Enter Your PNR Number"></td>
							<br>
			        <input type="submit" value="Cancel Ticket" name="Cancel_Ticket" class="toggle btn btn-primary" style="width:200px; margin-center: 70px;padding-bottom: 3px">
